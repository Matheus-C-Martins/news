<template>
  <main id="shows-page" class="news-container">
    <div class="header">
      <h1><fa icon="fa-solid fa-film" /> Entertainment News</h1>
      <p class="subtitle">Movies, TV shows, and entertainment updates</p>
    </div>
    
    <!-- Loading State -->
    <div v-if="isLoading" class="loading-state">
      <div class="spinner"></div>
      <p>Loading entertainment articles...</p>
    </div>
    ...
    <div v-else-if="articles.length === 0" class="no-results">
      ...
      <p>Check back later for more entertainment news</p>
    </div>
