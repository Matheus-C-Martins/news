<template>
  <main id="weather-page" class="news-container">
    <div class="header">
      <h1><fa icon="fa-solid fa-sun" /> Weather & Science News</h1>
      <p class="subtitle">Weather, climate, and scientific discoveries</p>
    </div>
    
    <!-- Loading State -->
    <div v-if="isLoading" class="loading-state">
      <div class="spinner"></div>
      <p>Loading science and weather articles...</p>
    </div>
    ...
    <div v-else-if="articles.length === 0" class="no-results">
      ...
      <p>Check back later for more science and weather news</p>
    </div>
